...
//        pageModels.add(new PageModel(R.layout.sample_point, R.string.title_draw_point, R.layout.practice_point));
        ...
        pageModels.add(new PageModel(R.layout.sample_grident, R.string.title_grident, R.layout.practice_grident));
        pageModels.add(new PageModel(R.layout.sample_color_filter, R.string.title_color_filter, R.layout.practice_color_filter));
        pageModels.add(new PageModel(R.layout.sample_xfermode, R.string.title_Xfermode, R.layout.practice_xfermode));
        pageModels.add(new PageModel(R.layout.sample_maskfilter, R.string.title_maskfilter, R.layout.practice_maskfilter));
        pageModels.add(new PageModel(R.layout.sample_clip, R.string.title_clip, R.layout.practice_clip));
        pageModels.add(new PageModel(R.layout.sample_clip, R.string.title_imageview, R.layout.practice_imageview));
        pageModels.add(new PageModel(R.layout.sample_clip, R.string.title_animator, R.layout.practice_animator));
        pageModels.add(new PageModel(R.layout.sample_clip, R.string.title_animator_degree, R.layout.practice_animator_degree));
        pageModels.add(new PageModel(R.layout.sample_clip, R.string.title_animator_evaluator, R.layout.practice_evaluator));
        pageModels.add(new PageModel(R.layout.sample_clip, R.string.title_animator_mesure, R.layout.practice_measure_imageview));
